...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_character_classes_give_options_for_a_character #Question: character classes?
  ...
  def test_slash_a_anchors_to_the_start_of_the_string 
    assert_equal "start", "start end"[/\Astart/] #Question: \A anchors to the start of the string
  ...
  def test_a_vertical_pipe_means_or
    ...
    assert_equal "Summer", "Summer Gray"[grays, 1] #Question: what the 1 in the []?
  ...
  def test_scan_is_like_find_all
    assert_equal ["one", "two", "three"], "one two-three".scan(/\w+/) #Question: .scan is awesome. and .sub and .gsub
  end
